Geezeo.views.CSRDetail = Ext.extend(Ext.Sheet, {
	...
	data: {},
	tpl:   '<div class="detailBlock"><div class="detailTitle">REQUEST FROM</div><div class="detailcontent">{reqfrom}</div></div>'
		 + '<div class="detailBlock"><div class="detailTitle">SHIP NAME</div><div class="detailcontent">{reqfrom}</shipname></div>'
		 + '<div class="detailBlock"><div class="detailTitle">C.O.N</div><div class="detailcontent">{con}</shipname></div>'
		 + '<div class="detailBlock"><div class="detailTitle">FAMILY</div><div class="detailcontent">{family}</shipname></div>'
		 + '<div class="detailBlock"><div class="detailTitle">CSR DATE</div><div class="detailcontent">{csrdate}</shipname></div>'
		 + '<div class="detailBlock"><div class="detailTitle">E.T.A PLACE</div><div class="detailcontent">{etaplace}</shipname></div>'
		 + '<div class="detailBlock"><div class="detailTitle">E.T.A COUNTRY</div><div class="detailcontent">{etacountry}</shipname></div>'
