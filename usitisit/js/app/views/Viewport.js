...
USitISit.views.Viewport = Ext.extend(Ext.Panel, {
	...
	initComponent : function() {
		...
		Ext.apply(this, {
			items : [USitISit.views.LoginForm, USitISit.views.DashboardForm, USitISit.views.RegistrationForm, USitISit.views.SpouseInfoForm, USitISit.views.InvitationForm, USitISit.views.AddFriendsForm, USitISit.views.ReqSitterForm, USitISit.views.FriendReqForm, USitISit.views.SitScheduleForm, USitISit.views.MyCircleForm, USitISit.views.FriendInfoForm]
		});
