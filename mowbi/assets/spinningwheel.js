...
var SpinningWheel = {
    ...
    */
    ...
    handleEvent: function (e) {
        if (e.type == 'mousedown') {
            ...
            this.lockScreen(e);
            e  = this.lastElement == null ? e : this.lastElement;
            if (e.currentTarget.id == 'sw-cancel' || e.currentTarget.id == 'sw-done') {
                this.tapCancel(e);
            } else if (e.currentTarget.id == 'sw-frame') {
                this.scrollMove(e);
    ...
    */
    ...
    create: function () {
        ...
        // Global events
        document.addEventListener('mouseup', this, false);            // Prevent page scrolling
    ...
    */
    ...
    scrollStart: function (e) {
        ...
        try { clickedClientX = e.targetTouches[0].clientX; }
        catch(ex1) {
           try { clickedClientX = e.clientX; }
           catch(ex2) { } 
        }
        
        var xPos = clickedClientX - this.swSlots.offsetLeft;;    // Clicked position minus left offset (should be 11px)
    ...
    scrollMove: function (e) {
        ...
        try { clickedClientY = e.targetTouches[0].clientY; }
        catch(ex1) {
           try { clickedClientY = e.clientY; }
           catch(ex2) { } 
        }
        
        var topDelta = clickedClientY - this.startY;
